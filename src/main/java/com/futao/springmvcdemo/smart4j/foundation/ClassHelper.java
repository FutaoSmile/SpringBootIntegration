...
import com.futao.springmvcdemo.smart4j.annotation.SmartController;
...
public class ClassHelper {
    ...
    private final static String BASE_PACKAGE_NAME = "com.futao.springmvcdemo.smart4j";
    ...
    public static Set<Class<?>> getClassSetByAnn(Class annotation) {
        return (Set<Class<?>>) CLASS_SET.stream().filter(it -> it.isAnnotationPresent(annotation)).collect(Collectors.toSet());
    }
